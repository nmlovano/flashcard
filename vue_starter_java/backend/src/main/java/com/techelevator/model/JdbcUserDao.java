...
<<<<<<< HEAD
	...
	public User saveUser(String userName, String password, String role, String first_name, String last_name,
		...
		long newId = jdbcTemplate.queryForObject(
				"INSERT INTO users(username, password, salt, role, first_name, last_name, email) VALUES (?, ?, ?, ?, ?,?,?) RETURNING id",
				Long.class, userName, hashedPassword, saltString, role, first_name, last_name, email);
...
=======
    ...
    @Override
    public User getUserByUsername(String username) {
        String sqlSelectUserByUsername = "SELECT id, username, first_name, last_name, role, email FROM users WHERE username = ?";
        SqlRowSet results = jdbcTemplate.queryForRowSet(sqlSelectUserByUsername, username);
